...
**1. 用于指代特定的事物或人**（基础 - A2/B1）

* 示例：_I saw a cat and a dog. **The** cat was black._
* 解释：初级到中级语言学习者常见的用法。

**2. 用于指代唯一的物体**（基础 - A2）

* 示例：_The sun is bright today._
* 解释：简单、基础的用法，适用于初级学习者。

**3. 用于谈论特定类型的场所**（中级 - B1/B2）

* 示例：_I’m going to **the** hospital._
* 解释：指代场所概念的用法，适用于中级水平。

#### 特定情境：

**1. 用于最高级和排名**（中级 - B1/B2）

* 示例：_That was **the** best day of my life._
* 解释：描述最高级或特定排序，适合中级学习者。

**2. 把形容词转为名词**（高级 - B2/C1）

* 示例：_We should care for **the** poor._
* 解释：该用法更抽象，通常在高级学习者中使用。

**3. 用于一般类别和独特实例**（中级 - B1/B2）

* 示例：_The car is an essential mode of transport._
* 解释：指代整体类别，适用于中级学习者。

#### 其他用法：

* **用于乐器和活动**（基础 - A2/B1）\
  示例：_He plays **the** guitar._
* **用于表示年代的数字**（中级 - B1/B2）\
  示例：_The 90s were a great time for music._
* **用于比较句**（高级 - B2/C1）\
  示例：_The more you practice, **the** better you get._
